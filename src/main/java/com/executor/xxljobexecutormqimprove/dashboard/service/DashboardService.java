...
public class DashboardService {
    ...
    public Map<String, Object> stats() {
        Map<String, Long> raw = dashboardMapper.countStats(System.currentTimeMillis());
    ...
    public Map<String, Object> tasks(int page, int size, String taskName, String bizName) {
        ...
        List<CommonTaskEntity> list = dashboardMapper.selectTasksPage(offset, size, taskName, bizName);
        long total = dashboardMapper.countTasks(taskName, bizName);
        Map<String, Object> result = new HashMap<>();
    ...
    public boolean toggleEnable(String id) {
        return dashboardMapper.toggleEnable(id) > 0;
    }

    public boolean delete(String id) {
        return dashboardMapper.deleteById(id) > 0;
    }
}
